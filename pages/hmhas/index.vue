<template>
    <div class="albums pt-16">
        <NuxtLink to="/" class="ms-10">
            <button type="button"
                class="px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700">
        ...
        <div class="text-gray-300 min-h-screen px-10 py-5">
            ...
            <div class="flex lg:flex-row md:flex-row sm:flex-col flex-col">
                <img class="mr-6 lg:w-96 lg:h-96 md:w-80 md:h-80 sm:w-72 sm:h-72 w-52 h-52"
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <h1 class="mt-0 mb-2 text-white lg:text-4xl md:text-3xl sm:text-3xl text-3xl text-bold">HIT ME HARD AND SOFT</h1>
