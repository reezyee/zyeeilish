<template>
    <div class="songs pt-16 pb-[50px] bg-[linear-gradient(0deg,_#020812_55%,_#132740_100%)] font-oswald">
        <NuxtLink to="/hmhas/" class="ms-10">
            <button type="button"
                class="px-5 py-2 text-sm text-gray-700 transition-colors duration-200 border rounded-lg gap-x-2 dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-800/10 shadow-sm shadow-black">
        ...
        <div
            ...
            <div class="flex flex-col gap-1">
                ...
                <p class="text-gray-200/40 text-x font-semibold text-slate-100/50">{{ songs?.penyanyi }}</p>
...
audio::-webkit-media-controls-panel {
  /* background: linear-gradient(360deg, #080e15, #0c1520); */
