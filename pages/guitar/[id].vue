<template>
    <div class="songs pt-16 pb-[50px] bg-[linear-gradient(0deg,_#020b05_55%,_#1a3e0c_100%)] font-oswald text-slate-100">
        <NuxtLink to="/guitar/" class="ms-10">
            <button type="button"
        ...
        <div
            ...
            <div class="flex flex-col gap-1">
                ...
                <audio :src="songs?.lagu" class="block w-full max-w-md mx-auto border-2 border-[#575350] shadow-md shadow-black" type="audio/mpeg" controls></audio>
            </div>
            <div class="lyrics">
                <div
