<template>
    <div class="albums pt-16 bg-[linear-gradient(0deg,_#020812_55%,_#132740_100%)] font-oswald">
        <NuxtLink to="/" class="ms-10">
            <button type="button"
                class="px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-800/10 shadow-sm shadow-black">
        ...
        <div class="text-gray-300 min-h-screen px-10 py-5">
            ...
            <div class="flex lg:flex-row md:flex-row sm:flex-col flex-col">
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <p class="mb-2 text-sm font-semibold">Billie Eilish, Finneas</p>
